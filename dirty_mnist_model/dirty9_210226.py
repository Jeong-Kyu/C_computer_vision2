...
test = pd.read_csv('C:/computervision2_data/dirty_mnist_data/dirty_mnist_2nd_answer.csv')
...
sub = pd.read_csv('C:/computervision2_data/dirty_mnist_data/sample_submission.csv')
i=np.zeros((1,256,256),dtype = np.int64, order='C')
for c in range(50000):   
    print(c)
    img_name = ('C:/computervision2_data/dirty_mnist_data/clean_dirty/train/'+str(c).zfill(5)+'.png')
...
test2 = test.drop(['index'],1) #인덱스 있는 것 버리기
y = test2.values
print(y.shape)
